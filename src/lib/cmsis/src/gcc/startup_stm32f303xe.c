/** \file  startup_stm32f303xe.c
 ** \brief  STM32F303xE system start-up
 ** \author S. Rossi
 **
...
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) FMC_IRQHandler(void);
...
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) I2C3_EV_IRQHandler(void);
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) I2C3_ER_IRQHandler(void);
...
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) TIM20_BRK_IRQHandler(void);
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) TIM20_UP_IRQHandler(void);
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) TIM20_TRG_COM_IRQHandler(void);
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) TIM20_CC_IRQHandler(void);
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) FPU_IRQHandler(void);
void __attribute__ ((weak, alias ("IRQ_DefaultHandler"))) SPI4_IRQHandler(void);


/** \brief IRQ vector type */
typedef void (* const pfnIRQHandler)(void);

/** \brief STM32F303xE Interrupt Vector Table */
...
pfnIRQHandler __isr_vectors[] =
{
    ...
    I2C1_EV_IRQHandler,             // I2C1 Event through EXTI Line 23
    I2C1_ER_IRQHandler,             // I2C1 Error
    I2C2_EV_IRQHandler,             // I2C2 Event
    I2C2_ER_IRQHandler,             // I2C2 Error
    SPI1_IRQHandler,                // SPI1
    SPI2_IRQHandler,                // SPI2
    USART1_IRQHandler,              // USART1 through EXTI Line 25
    USART2_IRQHandler,              // USART2 through EXTI Line 26
    USART3_IRQHandler,              // USART3 through EXTI Line 28
